...
var GLayerSwitchDialog = function (pParent, pEarth, callback) {
    ...
    var Feeders = [{ id: "imgFeeder01", name: "匯流排", lyrname: "busbar" }
		...
		, {id:"imgFeeder08",name:"三維線路展示",lyrname:"3DPipes"}
    ];
    /**
     * 設備圖層名稱與可見度紐ID設定
     * */
    var Equips = [
		...
		, { id: "imgEquip21", name: "故障指示器(群聚)", lyrname: "fcicluster" }
		...
		, { id: "imgEquip20", name: "再生能源(群聚)", lyrname: "distributedenergycluster" } //Soon 1100725 再生能源群聚顯示
    ...
    function GetLayerVisible(name) {
        ...
        switch (name) {
			...
			case "edge1":
				var visible = false;
				if (LineData1)
					var visible = LineData1.GetLayerVisible(name);
				return visible;
			case "busbar":
				var visible = false;
				if (LineData1)
			...
			case "3DPipes":
				return _3DSample.length > 0 ? _3DSample[0].Visible : false;
            default:
    ...
    for (var i = 0; i < Equips.length; i += 1) {
        var Rowtmp = DivEquipBody.appendObject("tr", null, { height: "40px" });
    ...
    var eye41 = Row41.appendObject("td", null, { width: "50%", position: "relative" }).appendObject("img", { id: "AL3Markers", class: "VisibilityButton", src: (INERAlertings.AL3s.VisibleFlag ? "../images/ToolWindow/VisibilityOn.svg" : "../images/ToolWindow/VisibilityOff.svg") });//狀態估測文字與告警Marker互斥，加上id以呼叫click事件 1100811 Soon
    AttachEvent(eye41, "click", function () {
        INERAlertings.SwitchMarkers(3);
        if (INERAlertings.AL3s.VisibleFlag) {
            $(this).prop("src", "../images/ToolWindow/VisibilityOn.svg");
			 //狀態估測文字與告警Marker互斥 1100811 Soon
			if(SEMarkers.AutoVisible)
				$('#SEMarkersAuto').click();
			if(SEMarkers.GeneralVisible)
				$('#SEMarkersGeneral').click();
        } else {
            $(this).prop("src", "../images/ToolWindow/VisibilityOff.svg");
        }
    });
    ...
    var eye42 = Row42.appendObject("td", null, { width: "50%", position: "relative" }).appendObject("img", { id: "AL2Markers", class: "VisibilityButton", src: (INERAlertings.AL2s.VisibleFlag ? "../images/ToolWindow/VisibilityOn.svg" : "../images/ToolWindow/VisibilityOff.svg") });//狀態估測文字與告警Marker互斥，加上id以呼叫click事件 1100811 Soon
    ...
    var eye43 = Row43.appendObject("td", null, { width: "50%", position: "relative" }).appendObject("img", { id: "AL1Markers", class: "VisibilityButton", src: (INERAlertings.AL1s.VisibleFlag ? "../images/ToolWindow/VisibilityOn.svg" : "../images/ToolWindow/VisibilityOff.svg") });//狀態估測文字與告警Marker互斥，加上id以呼叫click事件 1100811 Soon
    ...
    var Row45 = DivWarning.appendObject("tr", null, { height: "45px" });
    var Row451 = Row45.appendObject("td", null, { width: "50%" });
    Row451.appendObject("label", { class: "LayerToolLayerName" }).appendText("估測結果標記　　(自動化開關)");
    //Row451.appendObject("img", { class: "WarningSign", src: "../images/Notification/AL1.png" });
    var eye45 = Row45.appendObject("td", null, { width: "50%", position: "relative" }).appendObject("img", { id: "SEMarkersAuto", class: "VisibilityButton", src: (SEMarkers.AutoVisible ? "../images/ToolWindow/VisibilityOn.svg" : "../images/ToolWindow/VisibilityOff.svg") });//狀態估測文字與告警Marker互斥，加上id以呼叫click事件 1100811 Soon
    AttachEvent(eye45, "click", function () {
        SEMarkers.AutoVisible = !SEMarkers.AutoVisible;
		for(var i = 0; i < SEMarkers.Autolabel.length; i++)
		{
			SEMarkers.Autolabel[i].Visible = SEMarkers.AutoVisible;
		}
		if (SEMarkers.AutoVisible) {
            $(this).prop("src", "../images/ToolWindow/VisibilityOn.svg");
			 //狀態估測文字與告警Marker互斥 1100811 Soon
    ...
    var Row46 = DivWarning.appendObject("tr", null, { height: "45px" });
    var Row461 = Row46.appendObject("td", null, { width: "50%" });
    Row461.appendObject("label", { class: "LayerToolLayerName" }).appendText("估測結果標記　　(一般開關)");
    //Row451.appendObject("img", { class: "WarningSign", src: "../images/Notification/AL1.png" });
    var eye46 = Row46.appendObject("td", null, { width: "50%", position: "relative" }).appendObject("img", {  id: "SEMarkersGeneral", class: "VisibilityButton", src: (SEMarkers.GeneralVisible ? "../images/ToolWindow/VisibilityOn.svg" : "../images/ToolWindow/VisibilityOff.svg") });//狀態估測文字與告警Marker互斥，加上id以呼叫click事件 1100811 Soon
    AttachEvent(eye46, "click", function () {
        SEMarkers.GeneralVisible = !SEMarkers.GeneralVisible;
		if(SEMarkers.GeneralVisible && pCam.Position.Z < SEMarkers.GeneralMaxVisibleHeight)
		{
